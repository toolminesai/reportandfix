...
const capabilities = [
  { icon: ScanLine, title: 'Scan and report', copy: 'Capture a problem in seconds with location-aware reporting.' },
  { icon: ClipboardCheck, title: 'Track progress', copy: 'Follow every update from submission to verified resolution.' },
  { icon: ShieldCheck, title: 'Build trust', copy: 'Transparent ownership, accountability, and audit-ready history.' },
]
