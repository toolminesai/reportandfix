...
function authMessage(error: { message: string }) {
  ...
  if (message.includes('password')) return 'Please use a stronger password with at least 6 characters.'
